...
export function OperatorAvatar({ name, rank, image }: { name: string, rank: string, image: string }) {
  return (
    <div className="flex flex-col items-center gap-3 group">
      <div className="relative">
        ...
        <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 bg-surface border border-outline-variant/50 px-2 py-0.5 rounded-full">
          <span className="text-[8px] font-bold text-foreground tracking-widest">#{rank}</span>
        </div>
        {rank === "01" && (
    ...
    <main className="flex-1 overflow-y-auto bg-surface relative">
      ...
      <div className="p-8 space-y-12">
        <div className="relative aspect-[21/9] w-full overflow-hidden border border-outline-variant/20 group cut-corner">
          <img 
            src="https://picsum.photos/seed/battle/1200/500" 
            alt="Hero Battle" 
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <OperatorAvatar name="OPERATOR_AXL" rank="01" image="https://picsum.photos/seed/op1/200/200" />
            <OperatorAvatar name="GHOST_WALKER" rank="02" image="https://picsum.photos/seed/op2/200/200" />
            <OperatorAvatar name="ZEN_VOID" rank="03" image="https://picsum.photos/seed/op3/200/200" />
            <OperatorAvatar name="RAPTOR_7" rank="04" image="https://picsum.photos/seed/op4/200/200" />
          </div>
        </div>
